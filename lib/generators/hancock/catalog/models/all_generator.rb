...
module Hancock::Catalog::Models
  class AllGenerator < Rails::Generators::Base
    ...
    def all
      generate "hancock:catalog:models:item #{camelcased_class_name}"
      generate "hancock:catalog:models:category #{category_class_name}"
      generate "hancock:catalog:models:item_image #{image_class_name}"
      generate "hancock:catalog:models:category_image #{category_image_class_name}"
    end
